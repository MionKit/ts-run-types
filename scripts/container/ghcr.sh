# ghcr.sh - shared GitHub Container Registry (GHCR) helpers, sourced by
# scripts/container/image.sh and scripts/website/bench-data/bench.sh. Publishes the deps-only images so

...
fn: PureFunction<F>
```
Brands an inline function argument that passes the purity rules. The direct form: the argument is the helper itself. Used for [pure functions](/guide/pure-functions).
:::

:::card
---
title: Pure inline factories
---
```ts

...
| `createCloneExactShape` | Returns a NEW value of exactly the declared shape — undeclared keys are dropped by construction, the input is never mutated, and runtime types are preserved (Map stays Map, a class keeps its prototype). |

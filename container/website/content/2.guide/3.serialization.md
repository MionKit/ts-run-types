...
The `namespace` is a short owner string (like `'billing'`) that keeps a class name unique across packages. Register before anything serializes the class.

...
- `dynamic` (the default), `(val) => DataViewSerializer`, predicts a size from earlier encodes and grows the buffer in place when a value runs larger. You configure nothing, and it suits almost everyone.

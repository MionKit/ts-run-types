...
- Disk cache format **v9**: keys embed fnHash; payload is the tuple `ArgsText` (default-valued slots — interior ones too — rendered as JS holes via `typefns.holeifyArgs`) + persisted `IsNoop` bit.

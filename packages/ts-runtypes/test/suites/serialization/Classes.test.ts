// serialization / Classes — registered user classes run through every JSON
// encoder × decoder pairing and the binary round-trip. Decode reconstructs a
// real instance; here the suite asserts the DATA round-trips through every
// strategy (reconstruction / instanceof is pinned in the feature tests).
...
describe('serialization / Classes', () => {

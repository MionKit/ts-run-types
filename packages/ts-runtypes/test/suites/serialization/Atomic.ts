...
export const ATOMIC = {
  ...
  number_small: {
    title: 'number (small)',
    description: 'A small single-digit integer. Its JSON text is far shorter than a binary float64, so JSON is smaller on the wire here.',
  ...
  number_medium: {
    ...
    serializeNotes: 'JSON writes "123456" as 6 bytes; binary writes a fixed 8-byte float64. Around six to eight digits the two are about even.',
    mutateEncoder: () => createJsonEncoder<number>(undefined, {strategy: 'mutate'}),
    cloneEncoder: () => createJsonEncoder<number>(undefined, {strategy: 'clone'}),
    directEncoder: () => createJsonEncoder<number>(undefined, {strategy: 'direct'}),
    stripDecoder: () => createJsonDecoder<number>(),
  ...
  number_large: {
    title: 'number (large)',
    description: 'The largest safe integer (16 digits). Its JSON text needs 16 bytes against a fixed 8-byte binary float64, so binary is smaller on the wire.',
    serializeNotes: 'JSON writes Number.MAX_SAFE_INTEGER as 16 bytes; binary writes a fixed 8-byte float64. Large numbers favour binary on payload.',
    mutateEncoder: () => createJsonEncoder<number>(undefined, {strategy: 'mutate'}),
    cloneEncoder: () => createJsonEncoder<number>(undefined, {strategy: 'clone'}),
    directEncoder: () => createJsonEncoder<number>(undefined, {strategy: 'direct'}),
    stripDecoder: () => createJsonDecoder<number>(),
  ...
  number_float_short: {
    ...
    description: 'A short decimal with few significant digits. Its JSON text is shorter than a binary float64, so JSON is smaller on the wire.',
    serializeNotes: 'JSON writes "3.14" as 4 bytes; binary writes a fixed 8-byte float64. Low-precision floats favour JSON on payload.',
    mutateEncoder: () => createJsonEncoder<number>(undefined, {strategy: 'mutate'}),
    cloneEncoder: () => createJsonEncoder<number>(undefined, {strategy: 'clone'}),
    directEncoder: () => createJsonEncoder<number>(undefined, {strategy: 'direct'}),
    stripDecoder: () => createJsonDecoder<number>(),
  ...
  number_float_precise: {
    ...
    description: 'A full-precision double with 17 significant digits (pi). Its JSON text needs 17 bytes against a fixed 8-byte binary float64, so binary is smaller on the wire.',
    serializeNotes: 'JSON writes the 17-digit decimal as 17 bytes; binary writes a fixed 8-byte float64. High-precision floats favour binary on payload.',
    mutateEncoder: () => createJsonEncoder<number>(undefined, {strategy: 'mutate'}),
    cloneEncoder: () => createJsonEncoder<number>(undefined, {strategy: 'clone'}),
    directEncoder: () => createJsonEncoder<number>(undefined, {strategy: 'direct'}),
    stripDecoder: () => createJsonDecoder<number>(),

...
export const STRING_FORMAT = {
  string_maxLength: {
    ...
    compactEncoder: () => createJsonEncoder<TF.String<{maxLength: 5}>>(undefined, {strategy: 'compact'}),
    ...
    compactDecoder: () => createJsonDecoder<TF.String<{maxLength: 5}>>(undefined, {strategy: 'compact'}),
  ...
  uuidv4: {
    ...
    compactEncoder: () => createJsonEncoder<TF.UUIDv4>(undefined, {strategy: 'compact'}),
    stripDecoder: () => createJsonDecoder<TF.UUIDv4>(),
    preserveDecoder: () => createJsonDecoder<TF.UUIDv4>(undefined, {strategy: 'preserve'}),
    compactDecoder: () => createJsonDecoder<TF.UUIDv4>(undefined, {strategy: 'compact'}),
  ...
  date: {
    ...
    compactEncoder: () => createJsonEncoder<TF.StringDate>(undefined, {strategy: 'compact'}),
    stripDecoder: () => createJsonDecoder<TF.StringDate>(),
    preserveDecoder: () => createJsonDecoder<TF.StringDate>(undefined, {strategy: 'preserve'}),
    compactDecoder: () => createJsonDecoder<TF.StringDate>(undefined, {strategy: 'compact'}),
  ...
  email: {
    ...
    compactEncoder: () => createJsonEncoder<TF.Email>(undefined, {strategy: 'compact'}),
    stripDecoder: () => createJsonDecoder<TF.Email>(),
    preserveDecoder: () => createJsonDecoder<TF.Email>(undefined, {strategy: 'preserve'}),
    compactDecoder: () => createJsonDecoder<TF.Email>(undefined, {strategy: 'compact'}),
  ...
  alpha: {
    ...
    compactEncoder: () => createJsonEncoder<TF.Alpha>(undefined, {strategy: 'compact'}),
    stripDecoder: () => createJsonDecoder<TF.Alpha>(),
    preserveDecoder: () => createJsonDecoder<TF.Alpha>(undefined, {strategy: 'preserve'}),
    compactDecoder: () => createJsonDecoder<TF.Alpha>(undefined, {strategy: 'compact'}),
  ...
  object_with_formats: {
    ...
    compactEncoder: () => createJsonEncoder<{id: TF.UUIDv4; name: TF.String<{maxLength: 20}>}>(undefined, {strategy: 'compact'}),
    ...
    compactDecoder: () => createJsonDecoder<{id: TF.UUIDv4; name: TF.String<{maxLength: 20}>}>(undefined, {strategy: 'compact'}),

...
export const BIGINT_FORMAT = {
  bigint_int64: {
    ...
    compactEncoder: () => createJsonEncoder<TF.BigInt64>(undefined, {strategy: 'compact'}),
    stripDecoder: () => createJsonDecoder<TF.BigInt64>(),
    preserveDecoder: () => createJsonDecoder<TF.BigInt64>(undefined, {strategy: 'preserve'}),
    compactDecoder: () => createJsonDecoder<TF.BigInt64>(undefined, {strategy: 'compact'}),
  ...
  bigint_uint64: {
    ...
    compactEncoder: () => createJsonEncoder<TF.BigUInt64>(undefined, {strategy: 'compact'}),
    stripDecoder: () => createJsonDecoder<TF.BigUInt64>(),
    preserveDecoder: () => createJsonDecoder<TF.BigUInt64>(undefined, {strategy: 'preserve'}),
    compactDecoder: () => createJsonDecoder<TF.BigUInt64>(undefined, {strategy: 'compact'}),
  ...
  bigint_positive_string: {
    ...
    compactEncoder: () => createJsonEncoder<TF.BigPositive>(undefined, {strategy: 'compact'}),
    ...
    compactDecoder: () => createJsonDecoder<TF.BigPositive>(undefined, {strategy: 'compact'}),
  ...
  bigint_plain_brand: {
    ...
    compactEncoder: () => createJsonEncoder<TF.BigInt<{min: 0n; max: 255n}>>(undefined, {strategy: 'compact'}),
    ...
    compactDecoder: () => createJsonDecoder<TF.BigInt<{min: 0n; max: 255n}>>(undefined, {strategy: 'compact'}),

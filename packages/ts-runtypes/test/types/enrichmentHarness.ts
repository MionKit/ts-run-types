...
// src/enrichment/{friendlyType,mockData}.ts between the `#region …-extract`
...
const FRIENDLY_TS = fileURLToPath(new URL('../../src/enrichment/friendlyType.ts', import.meta.url));
const MOCK_TS = fileURLToPath(new URL('../../src/enrichment/mockData.ts', import.meta.url));

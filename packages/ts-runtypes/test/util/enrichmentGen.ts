...
import {loadCategorySpans, type CaseSpans} from './enrichmentCases.ts';

const HERE = dirname(fileURLToPath(import.meta.url));
const REPO_ROOT = resolve(HERE, '../../../..');
const BIN = resolve(REPO_ROOT, 'bin/ts-runtypes');
const TMP_ROOT = resolve(HERE, '../suites/enrichment/.tmp');

// The two test entries (`enrichmentGen`, `enrichmentCheck`) run in parallel and

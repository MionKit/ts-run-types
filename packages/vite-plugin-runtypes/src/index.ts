...
import type { TypeNode, Site } from "./protocol.js";
...
export default function runtypes(options: PluginOptions) {
  ...
  return {
    ...
    load(this: any, id: string) {
      ...
      const entries: Array<[string, TypeNode]> = Array.from(types.entries());
      return (
        "// generated by vite-plugin-runtypes\n" +
        "export const __runtypes = new Map(" +
    ...
    async transform(this: any, code: string, id: string) {
      ...
      for (const t of dump.types ?? []) types.set(t.id, t);

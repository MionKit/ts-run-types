...
/** Drives a case through BOTH JSON encoder + decoder modes (unsafe,
 *  safe, safe-direct), pairing same-mode halves. **/
export function runSerializationCase(c: SerializationCase): void {

...
describe('isType / OBJECT', () => {
  ...
  it('Self-referential interface via an array-of-self property', () => assertIsType(VALIDATION_SUITE.OBJECT.circular_interface_on_array));
  it('Self-referential interface buried in a nested object', () => assertIsType(VALIDATION_SUITE.OBJECT.circular_interface_on_nested_object));
  ...
  it('Parameters<F> tuple with a trailing optional argument', () => assertIsType(VALIDATION_SUITE.OBJECT.call_signature_params_with_optional));
...
describe('isType / UNION', () => {
  ...
  it('Discriminated union sharing one prop with arm-dependent type', () => assertIsType(VALIDATION_SUITE.UNION.union_same_prop_different_types));
  ...
  it('Union mixing arrays, plain objects, and index-signature shapes', () => assertIsType(VALIDATION_SUITE.UNION.union_mixed_with_index));
...
describe('isType / TEMPLATE_LITERAL', () => {
  ...
  it('Template literal starting with a string placeholder', () => assertIsType(VALIDATION_SUITE.TEMPLATE_LITERAL.leading_string_placeholder));
  it('Template literal with regex metacharacters in literal segments', () => assertIsType(VALIDATION_SUITE.TEMPLATE_LITERAL.regex_special_chars));
  it('Object with a template-literal-typed string property', () => assertIsType(VALIDATION_SUITE.TEMPLATE_LITERAL.template_literal_nested_in_object));
  it('Index signature whose key is a template literal pattern', () => assertIsType(VALIDATION_SUITE.TEMPLATE_LITERAL.template_literal_index_key));
...
describe('isType / CIRCULAR', () => {
  ...
  it('Self-referential object with optional self-ref and Date prop', () => assertIsType(VALIDATION_SUITE.CIRCULAR.object_full_mion_shape));
  it('Self-referential array whose union element includes the array itself', () => assertIsType(VALIDATION_SUITE.CIRCULAR.array_of_union_with_self_ref));

...
describe('format mockType / STRING_FORMAT', () => {
  ...
  it('FormatStringDate — absolute min/max bounds (inclusive)', () => assertMockType(STRING.date_minMax_absolute));
  ...
  it('FormatStringTime — absolute min/max bounds (business hours)', () => assertMockType(STRING.time_minMax_absolute));
  ...
  it('FormatStringDateTime — absolute min/max bounds', () => assertMockType(STRING.dateTime_minMax_absolute));

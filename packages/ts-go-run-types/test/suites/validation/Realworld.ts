...
export const REALWORLD = {
  ...
  blogPost: {
    ...
    getExpectedErrors: () => [
      [{path: ['tags', 0], expected: 'string'}, {path: ['tags', 1], expected: 'string'}],
  ...
  product: {
    ...
    getSamples: () => {
      ...
      return {
        ...
        invalid: [{...ok, currency: 'JPY'}, {...ok, dimensions: {width: 1, height: 2}}, {...ok, price: '9.99'}, null, 'not-an-object', 42],
      };
    },
    getExpectedErrors: () => [
  ...
  productPage: {
    ...
    getSamples: () => {
      ...
      return {
        ...
        invalid: [{...ok, data: [{...p, currency: 'JPY'}]}, {...ok, hasMore: 'no'}, {...ok, page: '1'}, null, 'not-an-object', 42],
      };
    },
    getExpectedErrors: () => [
  ...
  registrationForm: {
    ...
    getSamples: () => {
      ...
      return {
        ...
        invalid: [{...ok, acceptedTerms: false}, {...ok, profile: {firstName: 'Ann'}}, {...ok, password: 123456}, null, 'not-an-object', 42],
      };
    },
    getExpectedErrors: () => [

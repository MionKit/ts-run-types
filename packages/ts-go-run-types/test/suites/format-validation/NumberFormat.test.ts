// format-validation / NumberFormat — every NUMBER_FORMAT case run through isType, getTypeErrors,
...
describe('format-validation / NumberFormat', () => {
  for (const c of Object.values(NUMBER_FORMAT) as FormatValidationCase[]) {
    it(`isType — ${c.title}`, () => {

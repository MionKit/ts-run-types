// format-validation / BigintFormat — every BIGINT_FORMAT case run through isType, getTypeErrors,
...
describe('format-validation / BigintFormat', () => {
  for (const c of Object.values(BIGINT_FORMAT) as FormatValidationCase[]) {
    it(`isType — ${c.title}`, () => {

...
const mockBadUser = createMockData<User>(undefined, {mock: {invalid: true}});
...
const mockBadField = createMockData<User>(undefined, {mock: {invalid: true, invalidLeafProbability: 1}});
// end-invalid

...
const mockBadUser = createMockType<User>(undefined, {mock: {invalid: true}});
...
const mockBadField = createMockType<User>(undefined, {mock: {invalid: true, invalidLeafProbability: 1}});
// end-invalid

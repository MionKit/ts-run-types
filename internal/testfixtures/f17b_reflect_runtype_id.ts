...
import {reflectRuntypeId, type RuntypeId} from '@mionjs/ts-go-run-types';
...
// `id?: RuntypeId<T>` is what the scanner looks at; the callee identity
// is irrelevant.
...
// 17bf — foreign `RuntypeId` lookalike — declared outside the marker module.

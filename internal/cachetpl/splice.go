...
const (
	...
	SkeletonPrepareForJsonFlat     = "prepareForJsonFlatCache.ts"
	SkeletonRestoreFromJsonFlat    = "restoreFromJsonFlatCache.ts"
	SkeletonStringifyJsonFlat      = "stringifyJsonFlatCache.ts"
